...
public class SonataMain {
    public static void main(String[] args) {
        ...
        Sonata myCar2 = null; //역할이 없다
        myCar2 = (Sonata) context.getBean("myCar");
        System.out.println(myCar == myCar2);        // true 인스턴스가 같다

        // 대조군 만들기 - 좀 더
        Sonata himCar = (Sonata) context.getBean("himCar");
        Sonata himCar2 = (Sonata) context.getBean("himCar");
        System.out.println(himCar == himCar2);          //false 가 나와야 함
    }
}
/*
DI에 대한 실습 예제
...
눈으로 확인해 보자.
- new로 만든 객체는 만든 사람이 직접 생명주기를 관리한다.(위임이 아님)
