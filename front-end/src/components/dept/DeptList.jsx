...
const DeptList = () => {
  ...
  //사용자가 입력한 부서정보정보를 객체 리터럴로 담아서 서버에 전송한다
  // json -> 객체
  // 객체 -> json
  const deptInsert = async(value) => {
  ...
  return (
    <>
      ...
      <div className="row">
        ...
        <div className="col-6">
          <input type="text" id="keyword" className="form-control" placeholder="검색어를 입력하세요" aria-label="검색어를 입력하세요" aria-describedby="btn_search" />
        </div>
        <div className="col-3">
        ...
        <Modal.Body>
          <div style={{display: 'flex', flexWrap: 'wrap', justifyContent: 'center'}}>
            <div style={{display: 'flex'}}>
              <MyLabel>부서번호 <span style={{color:"red"}}></span>
